...
- Cockpit: o ESLint também voltou a rodar (`npm run lint --workspace=apps/cockpit`) e reporta 41 problemas (38 erros), quase todos `react-hooks/set-state-in-effect` da versão nova do plugin — pendência própria, não corrigida aqui.
