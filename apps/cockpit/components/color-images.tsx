...
// Bloco de fotos de uma cor (ou "Sem cor"). Vive em module scope — não recriar dentro do
// render de ColorImages, senão React remonta cada bloco a cada setData/setBusy.
function Bloco({
  titulo,
  color,
  images,
  ...
  onUpload: (files: FileList, color: string | null) => void
  onMove: (imageId: string, color: string | null) => void
