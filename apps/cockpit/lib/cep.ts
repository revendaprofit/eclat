// Cópia de apps/storefront/src/lib/util/cep.ts — o Cockpit é outro app Next, sem pacote
// compartilhado com a vitrine neste monorepo. Mudanças aqui precisam ir aos dois arquivos.
//
